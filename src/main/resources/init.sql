...
ALTER TABLE Testrating DROP CONSTRAINT IF EXISTS Testrating_fk0;

ALTER TABLE Testrating DROP CONSTRAINT IF EXISTS Testrating_fk1;
...
DROP TABLE IF EXISTS Testrating;
